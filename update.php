...
<body>
<center>
  <table width="797" height="108" border="0" cellpadding="0" cellspacing="0"  background="images/banner(3).jpg">
    <tr>
      <td>&nbsp;</td>
    </tr>
  </table>
	<table width="797" height="40" border="0" cellpadding="0" cellspacing="0" background="images/link(3).jpg">
    <tr>
      <td width="188" align="center" valign="middle"><b>
<?php echo date("Y-m-d")." ";?></b></td>
      <td width="98" align="center" valign="middle"><a href="select.php">浏览数据</a></td>
      <td width="100" align="center" valign="middle"><a href="index.php">添加图书</a></td>
      <td width="99" align="center" valign="middle"><a href="select.php">回到首页</a></td>
      <td width="99" align="center" valign="middle"><a href="chaxvn.php">高级查询</a></td>
      <td width="100" align="center" valign="middle"><a href="indexdel.php">批量管理</a></td>
      <td width="97" align="center" valign="middle"><a href="login.php">退出系统</a></td>
    </tr>
  </table>
<?php
...
<table width="797" height="48" border="0" cellpadding="0" cellspacing="0" background="images/bottom(3).jpg">
	<tr><td>&nbsp;</td></tr>
</table>
</center>
</body>
