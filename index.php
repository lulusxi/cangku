...
<?php echo date("Y-m-d")." ";?></b></td>
      <td width="90" align="center" valign="middle"><a href="select.php">浏览数据</a></td>
      <td width="94" align="center" valign="middle"><a href="index.php">添加图书</a></td>
      <td width="94" align="center" valign="middle"><a href="select.php">回到首页</a></td>
      <td width="91" align="center" valign="middle"><a href="chaxvn.php">高级查询</a></td>
      <td width="91" align="center" valign="middle"><a href="indexdel.php">批量管理</a></td>
      <td width="93" align="center" valign="middle"><a href="login.php">退出系统</a></td>
    </tr>
		</table>
		</td>
	</tr>
